...
def build_download_tab(win):
    ...
    win.vod_table.setColumnCount(7)
    win.vod_table.setHorizontalHeaderLabels(
        ["", "Type", "Platform", "Title", "Date", "Duration", "Views"]
    )
    ...
    vh.setSectionResizeMode(2, QHeaderView.ResizeMode.Fixed)
    vh.setSectionResizeMode(3, QHeaderView.ResizeMode.Stretch)
    vh.setSectionResizeMode(4, QHeaderView.ResizeMode.Interactive)
    vh.setSectionResizeMode(5, QHeaderView.ResizeMode.Fixed)
    vh.setSectionResizeMode(6, QHeaderView.ResizeMode.Fixed)
    win.vod_table.setColumnWidth(0, 36)
    win.vod_table.setColumnWidth(1, 72)
    win.vod_table.setColumnWidth(2, 84)
    win.vod_table.setColumnWidth(4, 160)
    win.vod_table.setColumnWidth(5, 96)
    win.vod_table.setColumnWidth(6, 72)
