...
from PyQt6.QtCore import QPoint, QSize, QThread, Qt, QTimer, QUrl, pyqtSignal
...
from PyQt6.QtWidgets import (
    ...
    QGridLayout, QHeaderView, QLabel, QLineEdit, QMenu, QPushButton, QSpinBox,
...
def build_storage_tab(win):
    ...
    metrics.addWidget(total_card, 1)
    metrics.addWidget(files_card, 1)
    metrics.addWidget(platforms_card, 1)
    ...
    maintenance_cards = QHBoxLayout()
    maintenance_cards.setSpacing(12)

    integrity_card = QFrame()
    integrity_card.setObjectName("card")
    integrity_lay = QVBoxLayout(integrity_card)
    integrity_lay.setContentsMargins(16, 14, 16, 14)
    integrity_lay.setSpacing(8)
    ...
    integrity_body.setVisible(True)
    integrity_lay.addWidget(integrity_body)
    integrity_options = QFrame()
    integrity_options.setObjectName("optionsRow")
    integrity_settings = QGridLayout(integrity_options)
    integrity_settings.setHorizontalSpacing(8)
    integrity_settings.setVerticalSpacing(6)
    ...
    integrity_settings.addWidget(win.integrity_scrub_enabled_check, 0, 0, 1, 2)
    interval_label = QLabel("Run every")
    interval_label.setObjectName("fieldLabel")
    integrity_settings.addWidget(interval_label, 1, 0)
    ...
    integrity_settings.addWidget(win.integrity_interval_spin, 1, 1)
    period_label = QLabel("Cover in")
    period_label.setObjectName("fieldLabel")
    integrity_settings.addWidget(period_label, 2, 0)
    ...
    integrity_settings.addWidget(win.integrity_period_spin, 2, 1)
    fraction_label = QLabel("per run")
    fraction_label.setObjectName("fieldLabel")
    integrity_settings.addWidget(fraction_label, 3, 0)
    ...
    integrity_settings.addWidget(win.integrity_fraction_spin, 3, 1)
    integrity_settings.setColumnStretch(1, 1)
    integrity_options.setVisible(False)
    integrity_lay.addWidget(integrity_options)
    ...
    win.storage_integrity_options_btn = QPushButton("Scrub schedule")
    win.storage_integrity_options_btn.setObjectName("ghost")
    win.storage_integrity_options_btn.setCheckable(True)
    win.storage_integrity_options_btn.toggled.connect(integrity_options.setVisible)
    integrity_actions.addWidget(win.storage_integrity_options_btn)
    ...
    maintenance_cards.addWidget(integrity_card, 1)

    maintenance_card = QFrame()
    maintenance_card.setObjectName("card")
    maintenance_lay = QVBoxLayout(maintenance_card)
    maintenance_lay.setContentsMargins(16, 14, 16, 14)
    maintenance_lay.setSpacing(8)
    ...
    maintenance_body.setVisible(True)
    ...
    retemplate_options = QFrame()
    retemplate_options.setObjectName("optionsRow")
    retemplate_row = QGridLayout(retemplate_options)
    retemplate_row.setHorizontalSpacing(8)
    retemplate_row.setVerticalSpacing(6)
    retemplate_label = QLabel("Re-template archive")
    retemplate_label.setObjectName("fieldLabel")
    retemplate_row.addWidget(retemplate_label, 0, 0, 1, 2)
    ...
    retemplate_row.addWidget(win.retemplate_folder_input, 1, 0, 1, 2)
    ...
    retemplate_row.addWidget(win.retemplate_file_input, 2, 0, 1, 2)
    ...
    retemplate_row.addWidget(win.retemplate_preview_btn, 3, 0)
    retemplate_row.setColumnStretch(1, 1)
    retemplate_options.setVisible(False)
    maintenance_lay.addWidget(retemplate_options)
    win.retemplate_options_btn = QPushButton("Re-template options")
    win.retemplate_options_btn.setObjectName("ghost")
    win.retemplate_options_btn.setCheckable(True)
    win.retemplate_options_btn.toggled.connect(retemplate_options.setVisible)
    retemplate_toggle_row = QHBoxLayout()
    retemplate_toggle_row.addWidget(win.retemplate_options_btn)
    retemplate_toggle_row.addStretch(1)
    maintenance_lay.addLayout(retemplate_toggle_row)
    ...
    maintenance_cards.addWidget(maintenance_card, 1)

    adoption_card = QFrame()
    adoption_card.setObjectName("card")
    adoption_lay = QVBoxLayout(adoption_card)
    adoption_lay.setContentsMargins(16, 14, 16, 14)
    adoption_lay.setSpacing(8)
    ...
    adoption_lay.addStretch(1)
    maintenance_cards.addWidget(adoption_card, 1)
    lay.addLayout(maintenance_cards)
    try:
    ...
    filter_wrap.setContentsMargins(14, 10, 14, 10)
    ...
    win.storage_table.setIconSize(QSize(96, 54))
