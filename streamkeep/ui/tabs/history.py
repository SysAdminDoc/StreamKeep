...
def build_history_tab(win):
    ...
    win.history_table.setColumnCount(6)
    ...
    win.history_table.setColumnWidth(0, 150)
    win.history_table.setColumnWidth(1, 84)
    win.history_table.setColumnWidth(3, 110)
    win.history_table.setColumnWidth(4, 88)
    ...
    style_table(win.history_table, 44)
