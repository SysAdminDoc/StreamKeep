...
_WEB_UI_TEXT = {
    ...
    "undo": _web_text("Undo"),
    "failure_discarded": _web_text("Failure discarded."),
    "failure_restored": _web_text("Failure restored."),
    "failure_restore_failed": _web_text("The discarded failure could not be restored."),
